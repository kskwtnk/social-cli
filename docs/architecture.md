...
│  │   async fn post_text(msg: &str) -> Result<...>; │         │
...
│bluesky.rs      │ │twitter.rs    │ │threads.rs    │
│                │ │              │ │              │
│ BlueskyClient  │ │TwitterClient │ │ThreadsClient │
│                │ │              │ │              │
│ impl Social-   │ │impl Social-  │ │impl Social-  │
│ Platform       │ │Platform      │ │Platform      │
└────┬───────────┘ └──────┬───────┘ └──────┬───────┘
     │                    │                 │
     ▼                    ▼                 ▼
┌──────────┐       ┌───────────┐    ┌─────────────┐
│ Bluesky  │       │ X (Twitter│    │  Threads    │
│ API      │       │    API)   │    │  API        │
│ atrium-* │       │ twitter-v2│    │  Meta Graph │
└──────────┘       └───────────┘    └─────────────┘
```
